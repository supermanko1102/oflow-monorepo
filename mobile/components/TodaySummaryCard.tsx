...
import type { PaymentStats, TimeRange } from "@/types/order";
import { PAYMENT_METHOD_LABELS, TIME_RANGE_LABELS } from "@/types/order";
      ...
      {paymentStats && (
        <View className="mt-4 pt-4 border-t border-gray-200">
          ...
          <View className="flex-row justify-around">
            {(
              Object.entries(paymentStats) as [keyof PaymentStats, number][]
            ).map(([method, amount]) => (
